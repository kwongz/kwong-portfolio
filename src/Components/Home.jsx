			...
			<header className="homepage-container">
				<div className="grid-container">
					...
					<div className="profile-text">
						...
						<div>
							<p>
								👋 I'm Kyle, a passionate front-end developer with over 3 years
								of experience. My expertise lies in crafting delightful user
								experiences using technologies like React, JavaScript, HTML, and
								CSS.
							</p>
							<p>
							...
							<p>
								💻 Let's Build Something Amazing Together! Explore my portfolio
								to see my work and get in touch for exciting collaborations.
							</p>
						</div>
					</div>
					...
					<div className="project-container">
						...
						<div className="project-description-container">
							<p>
								...
								similique accusantium, voluptatibus facere iusto culpa. Nulla
								sit, nesciunt blanditiis nam est aspernatur quidem alias
								similique quod vel, quo saepe pariatur incidunt. Sit rem fugit
								unde necessitatibus voluptatem debitis voluptate est sunt
								facilis, iure, qui temporibus mollitia, velit quis? Impedit,
								dolorum?
							</p>
							<a
								href="https://github.com/kwongz/kwong-portfolio/tree/master/src/gameComponents"
